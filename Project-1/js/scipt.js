...
var butMenu = document.querySelector('button.c-burger');
function menu() {
    if(butMenu.classList.contains('is-active')){
        butMenu.classList.remove('is-active');
    } else {
        butMenu.classList.add('is-active');
    }
}
